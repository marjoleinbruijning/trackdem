...
% \VignetteIndexEntry{\emph{trackdem}: Automated particle tracking to obtain population counts and size distributions from videos in R}
...
\begin{figure}[H]
\includegraphics[width=0.8\linewidth,page=1]{plot-1.png}
...
\begin{figure}[H]
\includegraphics[width=0.8\linewidth,page=1]{plotBackground-1.png}
...
\begin{figure}[H]
\includegraphics[width=0.8\linewidth,page=1]{plotBackgroundNoise-1.png}
\caption{Example of background obtained using function 
...
\begin{figure}[H]
\includegraphics[width=0.8\linewidth,page=1]{findThreshold.png}
...
\begin{figure}[H]
\includegraphics[width=0.8\linewidth,page=1]{plotpartIden-1.png}
...
<<trackParticlesHidden, eval=TRUE,results=hide >>=
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{plotRecords-1.png}
...
\begin{figure}[H]
\includegraphics[width=1\linewidth,page=1]{effectLR.pdf}
...
\begin{figure}[H]
\includegraphics[width=0.6\linewidth]{wrongTrajec.png}
...
\begin{figure}[H]
\includegraphics[width=0.8\linewidth,page=1]{trackdemManuallySelect.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Batch analysis} \label{sec:batch}
...
<<batchSetup, eval=TRUE,results=hide>>=
